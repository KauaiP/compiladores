...
int classenv_add_method(ClassEnv *env, const char *class_name,
                         const char *method_name,
                         char **param_types, int param_count,
                         const char *return_type);
int classenv_add_attr(ClassEnv *env, const char *class_name,
                        const char *attr_name, const char *type);

/* lookups */
ClassEntry *classenv_lookup_class(ClassEnv *env, const char *name);
MethodEntry *classenv_lookup_method(ClassEnv *env, const char *class_name,
                                     const char *method_name);
AttrEntry *classenv_lookup_attr(ClassEnv *env, const char *class_name,
...
int classenv_is_subtype(ClassEnv *env, const char *child,
                         const char *parent);
